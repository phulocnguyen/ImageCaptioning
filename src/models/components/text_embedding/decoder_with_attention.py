...
if __name__ == "__main__":
    ...
    caplens = 37
    imgs = torch.randn(2, 14, 14, 2048)
    caps = torch.randint(size=(2, caplens), low=0, high=vocab_size)
    
    predictions, encoded_captions, decode_lengths, alphas, sort_ind = net(imgs, caps, torch.full(size=(2, 1), fill_value=caplens, dtype=torch.int64))
